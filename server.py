...
async def generate_narrative(request: Request):
    ...
    # Don't filter — let the frontend render badges and offer a "Show muted"
    # toggle. List view always reflects current Agelia truth (within 60-second
    # cache window). Per-action UI badges still come from the pallas-incidents
    # mirror columns; they're independent of these annotations.
